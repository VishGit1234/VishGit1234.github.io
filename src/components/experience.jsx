      ...
      <div className="p-4 backdrop-blur-lg bg-slate-300/10 rounded-lg overflow-hidden lg:text-2xl">
        ...
        <div className="flex justify-center">
          <button onClick={ () => setShowFullDescription(
            ...
            <svg className="mt-[2px] " xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="#e2e8f0"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>
          </button>
        </div>
      </div>
    </>
